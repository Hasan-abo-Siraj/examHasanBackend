...
@section('main-title' , 'Edit Hasan Admin')

@section('sub-title' , 'Edit Hasan Admin')
            ...
            <form>
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  value="{{ $admins->user->password}}"  placeholder="Enter password of Admin">
                </div>
              </div>
              ...
              <div class="row">
                    {{-- <div class="form-group col-md-6">
                      ...
                      <select class="form-control select2" id="branch_id" name="branch_id" style="width: 100%;"> --}}
                        {{-- <option selected> {{ $admins->user->branch->name }} </option> --}}
